...
while (continueEnrollment) {
    ...
    while (true) {
        ...
        if (!studentIntro[studentKey]) {
            ...
            console.log(`Student with ID ${answer.studentID} already exists. Please enter a different ID.`);
        }
    }
    ...
    while (true) {
        ...
        if (studentCourses[studentKey].includes(courseAnswer.courses)) {
            console.log(`You are already enrolled in ${courseAnswer.courses}. Please select a different course.`);
            continue;
        }
        ...
        console.log(chalk.bold.blue(`Your tuition fee is ${chalk.bold.green(tuitionFees[courseAnswer.courses])}`));
        ...
        console.log(chalk.bold.blue(`You selected payment method ${chalk.bold.green(paymentType.payment)}`));
        ...
        if (paymentAmount === tuitionFee) {
            console.log(chalk.bold.blue(`Congratulations, you have successfully enrolled in ${courseAnswer.courses}`));
            ...
            // Handle overpayment
            console.log(chalk.bold.blue("Payment amount exceeds tuition fees. Please transfer the exact amount."));
            continue;
        }
        else {
            console.log(chalk.bold.blue("Insufficient payment. Please make the full payment."));
            continue;
        }
    ...
    if (ask.select === "viewstatus") {
        ...
        console.log(chalk.bold.blue(`Student name: ${chalk.bold.green(studentIntro[studentKey].name)}`));
